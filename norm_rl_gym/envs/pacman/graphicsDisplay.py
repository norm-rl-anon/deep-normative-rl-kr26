...
class InfoPane:
    def __init__(self, layout, gridSize, utils=None):
        ...
        if utils is None:
            self.graphics_util = GraphicsUtils()
        else:
            self.graphics_util = utils
        self.drawPane()
    ...
    def drawPane(self):
        self.scoreText = self.graphics_util.text(
    ...
    def updateGhostDistances(self, distances):
        ...
        if "ghostDistanceText" not in dir(self):
            ...
            for i, d in enumerate(distances):
                self.graphics_util.changeText(self.ghostDistanceText[i], d)
...
class PacmanGraphics:
    ...
    def drawDistributions(self, state):
        ...
        for x in range(walls.width):
            ...
            for y in range(walls.height):
                ...
                block = self.graphicsUtils.square(
                    (screen_x, screen_y), 0.5 * self.gridSize, color=BACKGROUND_COLOR, filled=1, behind=2
                )
                distx.append(block)
    ...
    def swapImages(self, agentIndex, newState):
        ...
        for item in prevImage:
            self.graphicsUtils.remove_from_screen(item)
    ...
    def drawGhost(self, ghost, agentIndex):
        ...
        if dir == "West":
            dx = -0.2
        leftEye = self.graphicsUtils.circle(
            (
        ...
        rightEye = self.graphicsUtils.circle(
            (
                screen_x + self.gridSize * GHOST_SIZE * (0.3 + dx / 1.5),
                screen_y - self.gridSize * GHOST_SIZE * (0.3 - dy / 1.5),
            ),
            ...
            for yNum, cell in enumerate(x):
                if cell:  # There's a wall here
                    ...
                    if (not nIsWall) and (not eIsWall):
                        # inner circle
                        self.graphicsUtils.circle(
                            screen2, WALL_RADIUS * self.gridSize, wallColor, wallColor, (0, 91), "arc", width=6
                        )
                    ...
                    if (not nIsWall) and (not wIsWall):
                        # inner circle
                        self.graphicsUtils.circle(
                            screen2, WALL_RADIUS * self.gridSize, wallColor, wallColor, (90, 181), "arc", width=6
                        )
                    ...
                    if (not sIsWall) and (not eIsWall):
                        # inner circle
                        self.graphicsUtils.circle(
                            screen2, WALL_RADIUS * self.gridSize, wallColor, wallColor, (270, 361), "arc", width=6
                        )
                    ...
                    if (not sIsWall) and (not wIsWall):
                        # inner circle
                        self.graphicsUtils.circle(
                            screen2, WALL_RADIUS * self.gridSize, wallColor, wallColor, (180, 271), "arc", width=6
                        )
        ...
        for xNum, x in enumerate(foodMatrix):
            ...
            for yNum, cell in enumerate(x):
                if cell:  # There's food here
                    ...
                    dot = self.graphicsUtils.circle(
                        screen, FOOD_SIZE * self.gridSize, outlineColor=color, fillColor=color, width=1
                    )
                    imageRow.append(dot)
                else:
    ...
    def drawExpandedCells(self, cells):
        ...
        for k, cell in enumerate(cells):
            ...
            block = self.graphicsUtils.square(screenPos, 0.5 * self.gridSize, color=cellColor, filled=1, behind=2)
...
def saveFrame(graphics_util: GraphicsUtils):
    ...
    FRAME_NUMBER += 1
    graphics_util.writePostscript(name)  # writes the current canvas
