...
class GameStateData:
    ...
    def __init__(self, prevState=None):
        ...
        """
        if prevState != None:
            self.food = prevState.food.deepCopy()
            ...
            self.agentEatenCnt = copy.deepcopy(prevState.agentEatenCnt)
    ...
    def initialize(self, layout, numGhostAgents):
        ...
        self._violations = 0
        self.agentEatenCnt = [0] * len(layout.agentPositions)
...
class Game:
            ...
            if self.catchExceptions:
                try:
                    ...
                    if self.totalAgentTimes[agentIndex] > self.rules.getMaxTotalTime(agentIndex):
                        self.totalAgentTimeWarnings[agentIndex] += 1
                        print(
                            "Agent %d ran out of time! (time: %1.2f, file=sys.stderr)"
                ...
                if agentIndex == 0:
                    action = agent.getAction(observation, train=self.train)
                else:
    ...
    def step(self, pacman_action):
        ...
        action
        """
        old_reward = self.state.deepCopy().getScore()
        self.state.killedBlue = False
        self.state.killedOrange = False
        self.state.ateCapsule = False
            ...
            if not self.gameOver:
                ...
                if agentIndex == 0:  # pacman
                    ...
                    if self.catchExceptions:
                        ...
                        # TODO: ADD HERE THE MONITOR WRAPPER and TRAINING SWITCH (?) (FIGURE OUT WHAT GYM DOES FOR )
                        action = agent.getAction(observation)
                    self.unmute()
